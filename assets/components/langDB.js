...
const about__descriptionEl = document.querySelector(
  ".about__announcement__description"
);
const about__announcement__buttonEl = document.querySelector(
  ".about__announcement__button"
);
const about__location__titleEl = document.querySelector(
  ".about__location__title"
);
const about__location__descriptionEl = document.querySelector(
  ".about__location__description"
);
const about__locationEl = document.querySelector(".about__location");
const about__schedule__titleEl = document.querySelector(
  ".about__schedule__title"
);
const about__schedule__descriptionEl = document.querySelector(
  ".about__schedule__description"
);
...
const announcement__subtitleEl = document.querySelector(
...
const templocation__descriptionEl = document.querySelector(
...
const location__descriptionEl = document.querySelector(
...
const contact__subtitleEl = document.querySelector(
...
const information__scheduleEl = document.querySelector(
  ".information__schedule"
);
const information__locationEl = document.querySelector(
...
link.forEach((el) => {
  el.addEventListener("click", () => {
    ...
    about__descriptionEl.innerHTML =
      data[attr].about__announcement__description;
    about__announcement__buttonEl.innerHTML =
      data[attr].about__announcement__button;
    about__location__titleEl.innerHTML = data[attr].about__location__title;
    about__location__descriptionEl.innerHTML =
      data[attr].about__location__description;
    about__locationEl.innerHTML = data[attr].about__location;
    about__schedule__titleEl.innerHTML = data[attr].about__schedule__title;
    about__schedule__descriptionEl.innerHTML =
      data[attr].about__schedule__description;
...
let data = {
  en: {
    ...
    biblestudy__address:
      '<i class="ri-map-pin-line qualification__modal-icon"></i>' +
    ...
    location__address:
      "Address: 1-chōme-28-6 Ishikawa Uruma, Okinawa 〒904-1106",
    ...
    left__contact:
      '<i class="ri-information-line"></i>' + "Contact Information",
    email__title: "E-mail",
  ...
  ja: {
    ...
    about__announcement__button:
      "お知らせ" + '<i class="ri-arrow-right-line"></i>',
